...
customlang/v2:switch between custom languages ​​(v2 loads the custom language folders in the modf/language folder).Open config.exe to select "custom" language(but if you are using kd2modlauncher, edit confmf.ini in a text editor)
