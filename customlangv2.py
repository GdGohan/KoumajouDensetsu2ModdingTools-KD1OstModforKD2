...
def rename_bckp_folder():
    ...
    if language:
        bckp_folder = os.path.join("data/language", "Custom")
        os.rename(bckp_folder, os.path.join("data/language", language))
        main()
...
def update_language_list(selected_item, selected_language):
    ...
    selected_language_folder = os.path.join("data/language", selected_item)
...
def load_languages():
    ...
    language_folders = os.listdir("data/language")
    for language in language_folders:
        if os.path.isdir(os.path.join("data/language", language)):
...
def main():
    ...
    custom_folder = os.path.join("data/language", "Custom")
